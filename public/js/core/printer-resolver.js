/**
 * NOC Enterprise - Printer Profile Resolver (Client Side)
 * Identificação dinâmica de fabricantes, modelos, tecnologias de impressão e protocolos.
...
function resolvePrinterProfile(rawName = '', rawModel = '', ip = '', serial = '') {
    ...
    window.PrinterResolver = {
        cleanPrinterName,
        resolvePrinterProfile
    };
    window.resolvePrinterProfile = resolvePrinterProfile;
})(window);
